...
The central-charts v1-scope decision ([central-charts-v1-scope](../decisions/central-charts-v1-scope-bar-heatmap-table.md)) explicitly **deferred** the master-item library and relationship-graph auto-JOIN out of phase 1, and the written spec (`.specs/central-charts/spec.md`, FR-1..13) reflects that deferral.
