...
- Complements the declarative-config pattern of [[q11-tooltips-declarative-fields-one-template]] and [[q9-chart-option-panels-schema-driven]]: defaults are automatic, manual control is fields in the spec.
