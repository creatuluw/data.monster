...
- Related: [[apparent-ui-bug-after-dev-server-restarts-stale-hmr-webview-]] (the other cause of "works in probes, broken for user" — stale HMR webview; Ctrl+R first, then re-probe).
