<script lang="ts">
	...
	const saData: SaItem[] = [
		{ id: 'src-01', label: 'PostgreSQL Production', meta: 'Revenue', icon: '◉' },
		{ id: 'src-02', label: 'Snowflake Analytics', meta: 'Marketing', icon: '◉' },
		{ id: 'src-03', label: 'S3 Data Lake', meta: 'Events', icon: '◉' },
		{ id: 'src-04', label: 'BigQuery Warehouse', meta: 'Finance', icon: '◉' },
		{ id: 'met-rev', label: 'Monthly Revenue', meta: 'REV-001', icon: '◆' },
		{ id: 'met-churn', label: 'Churn Rate', meta: 'CHN-201', icon: '◆' },
		{ id: 'met-mrr', label: 'MRR Growth', meta: 'MRR-102', icon: '◆' },
		{ id: 'met-nps', label: 'NPS Score', meta: 'NPS-401', icon: '◆' },
		{ id: 'grp-q4', label: 'Q4 2024', meta: '92 days', icon: '▨' },
		{ id: 'grp-q3', label: 'Q3 2024', meta: '92 days', icon: '▨' },
		{ id: 'grp-ytd', label: 'Year to Date', meta: '305 days', icon: '▨' },
		{ id: 'grp-custom', label: 'Custom Range', meta: 'Selectable', icon: '▨' },
		{ id: 'usr-01', label: 'Sarah Chen', meta: 'Analyst', icon: '◈' },
		{ id: 'usr-02', label: 'Marcus de Jong', meta: 'Manager', icon: '◈' },
	];
	...
	<div class="searchahead" onfocusout={(e) => { if (!e.currentTarget.contains(e.relatedTarget as Node)) close() }}>
		<div class="searchahead-input-wrap" class:has-dropdown={dropdownOpen}>
			<input
				...
				type="text"
				placeholder="Search sources, metrics, time ranges..."
				autocomplete="off"
