<script lang="ts">
	...
	import { ArrowLeft, Settings, BarChart2 } from 'lucide-svelte';
...
<svelte:head>
	<title>Chart Library — Data Monster</title>
</svelte:head>

<div class="chart-detail">
	<div class="chart-panel">
		<div class="chart-panel-header">
			<button class="back-btn" onclick={() => goto('/labs')} aria-label="Back to Labs">
				<ArrowLeft size={18} />
			</button>
			<span class="back-label">Labs</span>
			<div class="chart-panel-badge">
				<span class="section-number">CHART-001</span>
			</div>
		</div>
