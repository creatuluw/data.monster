<script lang="ts">
	...
	let chartId = $state('picasso-line-1');
...
<svelte:head>
	<title>Picasso Charts — Line/Area — Data Monster</title>
</svelte:head>
	...
	<div class="chart-panel">
		<div class="chart-panel-header">
			<div class="chart-panel-badge">
				<span class="section-number">PICASSO-002</span>
			</div>
		</div>
		<div class="chart-panel-body">
			{#if !config}
				<div class="chart-placeholder">
					...
					<p>Select a table, dimension, and metric to render a line or area chart with Picasso.js.</p>
				</div>
			{:else}
				<PicassoLineAreaChartCanvas {config} onPointClick={handlePointClick} />
			{/if}
			{#if clickedPoint}
				<div class="bar-toast">
