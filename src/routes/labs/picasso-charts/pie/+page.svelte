<script lang="ts">
	...
	let chartId = $state('picasso-pie-1');
...
<svelte:head>
	<title>Picasso Charts — Pie/Donut — Data Monster</title>
</svelte:head>
	...
	<div class="chart-panel">
		<div class="chart-panel-header">
			<div class="chart-panel-badge">
				<span class="section-number">PICASSO-003</span>
			</div>
		</div>
		<div class="chart-panel-body">
			{#if !config}
				<div class="chart-placeholder">
					...
					<p>Select a table, dimension, and metric to render a pie or donut chart with Picasso.js.</p>
				</div>
			{:else}
				<PicassoPieDonutCanvas {config} onSliceClick={handleSliceClick} />
			{/if}
			{#if clickedSlice}
				<div class="bar-toast">
			...
			<div class="config-section">
				...
				{:else if selectedTable && tableColumns.length > 0}
					...
					<div class="field">
						...
						<span class="field-hint">Pick a numeric column for slice proportions</span>
					</div>
				{/if}
			</div>
			...
			<div class="config-section">
				...
				<div class="field">
					...
					<input
						...
						bind:value={limit}
					/>
					<span class="field-hint">Best with 3–12 slices (default 12)</span>
				</div>
				...
				<label class="toggle-row">
					<div class="toggle-label">
						...
						<span class="toggle-hint">Category color legend on the right</span>
					</div>
					<button
						class="toggle"
